...
setwd('C:/Users/Erwin/Google Drive/PhD/many researchers project')
...
wb_soc =~ 1*wb_soc_1 + 1*wb_soc_2
wb =~ wb_gen + wb_phys + wb_psych + wb_soc

cnorm =~ 1*cnorm_1 + 1*cnorm_2
...
#one indicator of each 2-item factor has negative variance: try constraining factor loadings instead. 
